...
export const contentThemes: ContentTheme[] = [
  ...
  },
  {
    id: 'daily-warm',
    name: '日暖',
    description: '温暖亲和，轻松好读',
    fontFamily: "'Noto Sans SC', 'Source Han Sans SC', 'PingFang SC', 'Microsoft YaHei', sans-serif",
    headingFont: "'Noto Sans SC', 'Source Han Sans SC', 'PingFang SC', sans-serif",
    codeFont: "'Source Code Pro', 'JetBrains Mono', 'Consolas', monospace",
    accentColor: '#b8584b',
    textColor: '#3d3632',
    headingColor: '#2c2420',
    mutedColor: '#8c827a',
    linkColor: '#b8584b',
    blockquoteBg: '#fdf6ef',
    blockquoteBorder: '#d4a07a',
    codeBg: '#f8f1e8',
    codeTextColor: '#a05535',
    tableBorderColor: '#e8ddd0',
    tableHeaderBg: '#f5ede2',
    hrColor: '#e0d4c5',
    previewBg: '#fffbf5',
  },
  {
